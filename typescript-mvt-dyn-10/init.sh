...
app=products
App=${app^}
mkdir src src/$app src/$app/view src/$app/model src/$app/template src/$app/public src/$app/router test test/$app test/$app/view test/$app/model config docs build
## source
