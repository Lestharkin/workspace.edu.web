...
var _numArray = [0, 1, 2];
out = 'Number array = [';
_numArray.forEach(function (i) {
    out += " ".concat(i, " ");
});
console.log(out + ']');
var _booArray = [true, false];
out = 'Boolean array = [';
_booArray.forEach(function (i) {
    out += " ".concat(i, " ");
});
console.log(out + ']');
var _strArray = ['text0', 'text1', 'test2'];
out = 'String array = [';
_strArray.forEach(function (i) {
    out += " ".concat(i, " ");
});
console.log(out + ']');
var _arrayAny = [
...
console.log("addFun = ".concat(addFunc(5, 3)));
...
var childOfUser = new ChildOfUser({
    id: 98,
    names: 'javier',
    lastNames: 'gil',
    age: 18,
